...
lastmod: 2026-08-05T09:30:00+03:00
draft: false
keywords:
  - mc1440701
...
![Το Microsoft Defender for Office 365 βάζει σε quarantine κρυπτογραφημένα συνημμένα που δεν μπορεί να σαρώσει](/images/MDO-EncryptedAttachments/mdo-encrypted-attachment-cover.png)
...
![Πώς λειτουργεί η προστασία κρυπτογραφημένων συνημμένων στο MDO, από το εισερχόμενο email μέχρι την ελεγχόμενη αποδέσμευση](/images/MDO-EncryptedAttachments/mdo-how-it-works-flow.png)
...
![Οι δύο δρόμοι αποδέσμευσης από την καραντίνα: ο χρήστης με το password του συνημμένου και ο διαχειριστής χωρίς αυτό](/images/MDO-EncryptedAttachments/mdo-release-paths.png)
...
![Οι κανόνες ασφάλειας για τους χρήστες κατά την αποδέσμευση: μόνο ο κωδικός του συνημμένου, ποτέ account ή banking credentials](/images/MDO-EncryptedAttachments/mdo-security-dos-donts.png)
...
![Χρονοδιάγραμμα διάθεσης της δυνατότητας ανά cloud environment, από τον Αύγουστο έως τον Οκτώβριο 2026](/images/MDO-EncryptedAttachments/mdo-rollout-timeline.png)
